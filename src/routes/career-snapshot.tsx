      ...
      <div className="min-h-screen bg-background text-foreground pb-20 relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-fade-up">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-xs font-bold text-muted-foreground">• Live Studio</span>
                </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="rounded-xl text-xs font-bold gap-1.5 h-8.5 border-border hover:bg-secondary text-foreground"
                >
                ...
                <Button
                  ...
                  className="bg-[#0A66C2] hover:bg-[#0A66C2]/90 text-white rounded-xl text-xs font-bold gap-1.5 h-8.5 shadow-2xs cursor-pointer"
                >
        ...
        <main className="max-w-6xl mx-auto px-6 pt-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {/* LEFT COLUMN: STREAMLINED CONTROLS (5 cols) */}
            <div className="lg:col-span-5 space-y-5 animate-fade-up">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected
                            ? "bg-foreground text-background shadow-2xs scale-[1.02] ring-2 ring-brand/30"
                            : "bg-secondary text-foreground hover:bg-secondary/80 border border-border/50"
                        )}
                      >
                        {tmpl.name}
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isChecked
                            ? "bg-brand/10 border border-brand/40 text-brand font-bold shadow-2xs"
                            : "bg-secondary/50 border border-border/50 text-muted-foreground opacity-60"
                        )}
                      >
                        <span>{stat.label}</span>
                        <strong className="text-foreground tabular-nums">({stat.value})</strong>
              ...
              {/* 4. LINKEDIN POST (DIRECTLY EDITABLE) */}
              <div className="space-y-2 pt-1">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {(["professional", "personal", "technical"] as CaptionTone[]).map((t) => (
                      <button
                        ...
                        className={cn(
                          "text-[10px] font-bold px-2 py-0.5 rounded-md capitalize transition-all cursor-pointer",
                          captionTone === t
                    ...
                    <button
                      ...
                      className="text-xs text-brand hover:opacity-80 p-1 cursor-pointer ml-1"
                ...
                <Textarea
                  ...
                  rows={8}
                  placeholder="Personalized LinkedIn post..."
                  className="w-full text-xs font-normal rounded-2xl border-border/70 bg-card p-3 leading-relaxed focus-visible:ring-brand"
                />
                ...
                <div className="flex items-center justify-between text-[11px] text-muted-foreground pt-0.5">
                  <label className="flex items-center gap-1.5 cursor-pointer font-medium">
                    ...
                    />
                    <span>Attach SkillVerse Link</span>
                  </label>
                  ...
                  <Button
                    ...
                    className="text-xs font-bold text-brand h-6 px-2"
                  >
                    {copiedCaption ? <Check className="h-3 w-3 mr-1" /> : <Copy className="h-3 w-3 mr-1" />}
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-3">
                ...
                {/* Poster Display Surface with Ambient Glow */}
                <div className="p-4 sm:p-6 rounded-3xl border border-border/70 bg-secondary/30 flex items-center justify-center relative overflow-hidden">
                  <PosterPreview
                    ref={posterRef}
                    templateId={selectedTemplateId}
                    achievement={currentAchievement}
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    {shareHistory.slice(0, 4).map((item) => (
                      <div
                        key={item.id}
                        className="p-3 rounded-2xl border border-border/70 bg-card shadow-2xs flex items-center justify-between gap-3 text-xs"
                      >
                        <div className="min-w-0">
                          <span className="block font-bold text-foreground truncate">{item.storyTitle}</span>
                          <span className="block text-[10px] text-muted-foreground capitalize">
                            {item.templateId} • {item.status} • {new Date(item.createdAt).toLocaleDateString()}
                          </span>
                        </div>
                        ...
                        <Button
                          ...
                          className="text-[11px] font-bold text-brand h-7 px-2.5 hover:bg-brand/10"
                        >
                          Reuse
                        </Button>
                      </div>
