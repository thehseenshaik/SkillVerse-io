      ...
      <div className="min-h-screen bg-background text-foreground pb-20">
        ...
        <main className="mx-auto max-w-6xl px-6 pt-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {/* RIGHT COLUMN: SIMPLIFIED TABBED CUSTOMIZER (5 Cols) */}
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="flex rounded-2xl bg-secondary/60 p-1 border border-border/60">
                <button
                  ...
                  className={cn(
                    "flex-1 inline-flex items-center justify-center gap-2 rounded-xl py-2 text-xs font-extrabold transition-all cursor-pointer",
              ...
              {activeRightTab === "customize" && (
                <div className="space-y-4 animate-fade-up">
                  {/* Story Focus */}
                  <Card className="p-5 rounded-3xl border border-border/70 space-y-3">
                  ...
                  <Card className="p-5 rounded-3xl border border-border/70 space-y-3">
                      ...
                      <div className="flex items-center gap-1">
                        {(["professional", "personal", "technical"] as CaptionTone[]).map((t) => (
                          <button
                            ...
                            className={cn(
                              "text-[10px] font-bold px-2 py-1 rounded-lg capitalize border transition-all cursor-pointer",
                              captionTone === t
                    ...
                    <div className="flex items-center justify-between text-xs pt-1">
                      <label className="flex items-center gap-2 cursor-pointer text-muted-foreground font-medium select-none">
                        ...
                        />
                        <span>Include Profile Link</span>
                      </label>
