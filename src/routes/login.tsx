...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Log in to SkillVerse — your unified career operating system.",
      },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Log in — SkillVerse" },
      {
        property: "og:description",
        content: "Access your Career Command Center.",
      },
    ],
  }),
  component: LoginPage,
  ...
  useEffect(() => {
    if (hydrated && isAuthenticated) {
      ...
      if (redirect && redirect !== "/") {
        console.log("[LoginPage] User already authenticated, redirecting to:", redirect);
