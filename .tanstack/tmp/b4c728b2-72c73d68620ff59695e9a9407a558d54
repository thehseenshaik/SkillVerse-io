...
export const Route = createFileRoute('/connections-backup')({
  component: () => (
    <AuthGate>
      <ConnectionsPage />
    </AuthGate>
    ...
    <PageShell>
      <div className="relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {/* GitHub Card */}
          <div className="p-4 bg-gradient-to-br from-muted/30 to-muted/10 rounded-xl border border-border/50 shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            {github.connected ? (
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between text-xs text-muted-foreground">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2.5 py-1 bg-gradient-to-r from-brand to-brand-strong text-white rounded-md text-xs font-medium hover:shadow-md transition-all duration-200 disabled:opacity-50"
                  >
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full py-2 text-sm font-medium bg-gradient-to-r from-brand to-brand-strong text-white rounded-lg hover:shadow-md transition-all duration-200 shadow-sm disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {isValidating ? (
                    <>
